param(
    ...
    [string[]]$PromptId = @(),
    [string]$StatusFile = "Experiments/Experiment 1.1/logs/status_latest.log",
...
$containerArgs = @(
    ...
    $ImageName,
    "python3",
    "Experiments/Experiment 1.1/brain_sandbox_advanced.py",
    "--model-path",
...
Write-Host "Running Experiment 1.1 against model: $resolvedModelPath" -ForegroundColor Green
...
if ($LASTEXITCODE -ne 0) {
    throw "Experiment 1.1 container exited with code $LASTEXITCODE"
}
